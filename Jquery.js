...
$(".filter-btn").on("click", function () {
  $(".main-sidebar-div").toggleClass("check");
});
...
$(document).ready(function () {
  $("#mySearch").on("keyup", function () {
    ...
    $(".main-Spring-card-wrapper, .main-arrival-card-wrapper").each(
      function () {
        var products = $(this).find(
          ".Spring-card-wrapper, .arrival-card-wrapper"
        );
